...
# ----------------
# Mathch only the *active* target rows (end_date is NULL) with the same business key.
# If any tacked column differs, set end_date to end_timestamp to retire that version
